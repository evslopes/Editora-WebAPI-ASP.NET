...
namespace Editora.Web.Controllers
{
    public class AutorsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var request = new RestRequest("https://localhost:44366/api/autors", DataFormat.Json);
        ...
        public ActionResult GetAutor(int id)
        {
            ...
            var request = new RestRequest("https://localhost:44366/api/autors" + id, DataFormat.Json);
            request.AddHeader("Authorization", "Bearer " + this.HttpContext.Session.GetString("Token"));
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,UltimoNome,Email,DataNascimento")] Autor autor)
        {
            try
            {
                ...
                var client = new RestClient();
                var request = new RestRequest("https://localhost:44324/api/autors", DataFormat.Json);
        ...
        {
            var client = new RestClient();
            var request = new RestRequest("https://localhost:44324/api/autors/" + id, DataFormat.Json);
            request.AddHeader("Authorization", "Bearer " + this.HttpContext.Session.GetString("Token"));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,UltimoNome,Email,DataNascimento")] Autor autor)
        {
            if (id != autor.Id)
            {
                return NotFound();
